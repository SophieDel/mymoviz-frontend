...
function Home() {
  ...
  //   moviesData[i].poster = `https://www.themoviedb.org/t/p/w440_and_h660_face${moviesData[i].poster_path}`
  //   moviesData[i].title = moviesData[i].original_title
  //   if (moviesData[i].overview.length > 250) {
  //     moviesData[i].overview = `${moviesData[i].overview.slice(0, 250)}...`;
  //   } else {
  //     moviesData[i].overview = moviesData[i].overview
  //   }
  // }
  ...
  const movies = moviesData.map((data, i) => {
    ...
    return (
      <Movie
        ...
        overview={(data.overview.length > 250 ? `${data.overview.slice(0, 250)}...` : data.overview)}
        poster={ `https://www.themoviedb.org/t/p/w440_and_h660_face${data.poster_path}`}
